...
$H_0$: gun ownership and opion capital punishment 
related 

OWNGUN~ CAPPUN both are categorical, thus us use
...
this barchart shows gu owner are more likely to favor capital punishment 
...
```{r}
table2 <- xtabs(~OWNGUN + CAPPUN, data=GSSdata)
rowPerc(table2)
colPerc(table2)
```
